        ...
        <div class="middleBlock md:w-1/3 justify-center border-l border-r border-gray-300">
           ...
           <div class="cuiitBox border-b border-gray-300 flex p-3 sm:">
              <div class="postArea">
                ...
                <form class="flex flex-col p-4" method="POST" action="./accueil" id="formPostCuiit">
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div class="button flex justify-between">
                      <button class="bg-green-500 hover:bg-green-600 rounded text-white p-2 w-32 flex justify-center items-center" name="cuiit_button">Cuiiter   <i class="fa-regular fa-paper-plane-top"></i></button>
                    </div>
                  </div>
                ...
                <div class=\"flex items-start p-4 border-b\">
                  ...
                  <div class=\"flex-1\">
                    <div class=\"block\">
                      ...
                      <a href=\"#\" class=\"text-gray-500 mr-2\" onclick=\"showAccount(".$cuiit['id'].", ".$mainId.")\">@".$cuiit['nickname']."</a>
                    ...
                    echo "<div class=\"flex justify-between items-center mt-4\">
                      <div class=\"flex items-center\">
                        ...
                        <a href=\"comments\" class=\"comment text-gray-500 mr-4 hover:text-green-500\">
                        ...
                        <button class=\"text-gray-500 mr-4 hover:text-blue-500\" onclick=\"add_like(".$cuiit_id.", ".$mainId.")\">
